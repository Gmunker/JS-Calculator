$(function() {
  ...
  alert("Currently some of the functions are not working, I have not maintained this project since completing it. I will be finding time in the near future to update it. For now please enjoy my CSS design. ")
